...
Namespace dermas_ws
    ...
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="Service1Soap", [Namespace]:="http://tempuri.org/WS_DERMAS/Service1")>  _
    Public Class Service1
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://www.dermas.net/WS_DERMAS/Service1.asmx"
        End Sub
        
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/WS_DERMAS/Service1/AltaCita", RequestNamespace:="http://tempuri.org/WS_DERMAS/Service1", ResponseNamespace:="http://tempuri.org/WS_DERMAS/Service1", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        ...
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/WS_DERMAS/Service1/BajaCita", RequestNamespace:="http://tempuri.org/WS_DERMAS/Service1", ResponseNamespace:="http://tempuri.org/WS_DERMAS/Service1", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        ...
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/WS_DERMAS/Service1/CambioEstado", RequestNamespace:="http://tempuri.org/WS_DERMAS/Service1", ResponseNamespace:="http://tempuri.org/WS_DERMAS/Service1", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function CambioEstado(ByVal login As String, ByVal password As String, ByVal ds_cambio_estado As ds_cambio_estado) As String
            Dim results() As Object = Me.Invoke("CambioEstado", New Object() {login, password, ds_cambio_estado})
            Return CType(results(0),String)
        End Function
        
        '<remarks/>
        Public Function BeginCambioEstado(ByVal login As String, ByVal password As String, ByVal ds_cambio_estado As ds_cambio_estado, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("CambioEstado", New Object() {login, password, ds_cambio_estado}, callback, asyncState)
        End Function
        
        '<remarks/>
        Public Function EndCambioEstado(ByVal asyncResult As System.IAsyncResult) As String
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),String)
        End Function
    End Class
    ...
    <Serializable(),  _
     ...
     System.Diagnostics.DebuggerStepThrough(),  _
     System.ComponentModel.ToolboxItem(true)>  _
    Public Class ds_cambio_estado
        Inherits DataSet
        
        Private tablecambio_estado As cambio_estadoDataTable
        ...
        Protected Sub New(ByVal info As SerializationInfo, ByVal context As StreamingContext)
            ...
            If (Not (strSchema) Is Nothing) Then
                Dim ds As DataSet = New DataSet
                ds.ReadXmlSchema(New XmlTextReader(New System.IO.StringReader(strSchema)))
                If (Not (ds.Tables("cambio_estado")) Is Nothing) Then
                    Me.Tables.Add(New cambio_estadoDataTable(ds.Tables("cambio_estado")))
                End If
                Me.DataSetName = ds.DataSetName
                Me.Prefix = ds.Prefix
                Me.Namespace = ds.Namespace
        ...
        <System.ComponentModel.Browsable(false),  _
         System.ComponentModel.DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Content)>  _
        Public ReadOnly Property cambio_estado As cambio_estadoDataTable
            Get
                Return Me.tablecambio_estado
            End Get
        End Property
        
        Public Overrides Function Clone() As DataSet
            Dim cln As ds_cambio_estado = CType(MyBase.Clone,ds_cambio_estado)
            cln.InitVars
            Return cln
        End Function
        ...
        Friend Sub InitVars()
            Me.tablecambio_estado = CType(Me.Tables("cambio_estado"),cambio_estadoDataTable)
            If (Not (Me.tablecambio_estado) Is Nothing) Then
                Me.tablecambio_estado.InitVars
            End If
        End Sub
        
        Private Sub InitClass()
            Me.DataSetName = "ds_cambio_estado"
            Me.Prefix = ""
            Me.Namespace = "http://tempuri.org/ds_cambio_estado.xsd"
            Me.Locale = New System.Globalization.CultureInfo("en-US")
            Me.CaseSensitive = false
            Me.EnforceConstraints = true
            Me.tablecambio_estado = New cambio_estadoDataTable
            Me.Tables.Add(Me.tablecambio_estado)
        End Sub
        
        Private Function ShouldSerializecambio_estado() As Boolean
            Return false
        End Function
        ...
        Public Delegate Sub cambio_estadoRowChangeEventHandler(ByVal sender As Object, ByVal e As cambio_estadoRowChangeEvent)
        
        <System.Diagnostics.DebuggerStepThrough()>  _
        Public Class cambio_estadoDataTable
            Inherits DataTable
            Implements System.Collections.IEnumerable
            ...
            Public Default ReadOnly Property Item(ByVal index As Integer) As cambio_estadoRow
                Get
                    Return CType(Me.Rows(index),cambio_estadoRow)
                End Get
            End Property
            
            Public Event cambio_estadoRowChanged As cambio_estadoRowChangeEventHandler
            
            Public Event cambio_estadoRowChanging As cambio_estadoRowChangeEventHandler
            
            Public Event cambio_estadoRowDeleted As cambio_estadoRowChangeEventHandler
            
            Public Event cambio_estadoRowDeleting As cambio_estadoRowChangeEventHandler
            
            Public Overloads Sub Addcambio_estadoRow(ByVal row As cambio_estadoRow)
                Me.Rows.Add(row)
            End Sub
            
            Public Overloads Function Addcambio_estadoRow(ByVal epis_key_cima As Integer, ByVal estado As String) As cambio_estadoRow
                Dim rowcambio_estadoRow As cambio_estadoRow = CType(Me.NewRow,cambio_estadoRow)
                rowcambio_estadoRow.ItemArray = New Object() {epis_key_cima, estado}
                Me.Rows.Add(rowcambio_estadoRow)
                Return rowcambio_estadoRow
            End Function
            ...
            Public Overrides Function Clone() As DataTable
                Dim cln As cambio_estadoDataTable = CType(MyBase.Clone,cambio_estadoDataTable)
                cln.InitVars
                Return cln
            End Function
            
            Protected Overrides Function CreateInstance() As DataTable
                Return New cambio_estadoDataTable
            End Function
            ...
            Public Function Newcambio_estadoRow() As cambio_estadoRow
                Return CType(Me.NewRow,cambio_estadoRow)
            End Function
            
            Protected Overrides Function NewRowFromBuilder(ByVal builder As DataRowBuilder) As DataRow
                Return New cambio_estadoRow(builder)
            End Function
            
            Protected Overrides Function GetRowType() As System.Type
                Return GetType(cambio_estadoRow)
            End Function
            
            Protected Overrides Sub OnRowChanged(ByVal e As DataRowChangeEventArgs)
                MyBase.OnRowChanged(e)
                If (Not (Me.cambio_estadoRowChangedEvent) Is Nothing) Then
                    RaiseEvent cambio_estadoRowChanged(Me, New cambio_estadoRowChangeEvent(CType(e.Row,cambio_estadoRow), e.Action))
                End If
            End Sub
            
            Protected Overrides Sub OnRowChanging(ByVal e As DataRowChangeEventArgs)
                MyBase.OnRowChanging(e)
                If (Not (Me.cambio_estadoRowChangingEvent) Is Nothing) Then
                    RaiseEvent cambio_estadoRowChanging(Me, New cambio_estadoRowChangeEvent(CType(e.Row,cambio_estadoRow), e.Action))
                End If
            End Sub
            
            Protected Overrides Sub OnRowDeleted(ByVal e As DataRowChangeEventArgs)
                MyBase.OnRowDeleted(e)
                If (Not (Me.cambio_estadoRowDeletedEvent) Is Nothing) Then
                    RaiseEvent cambio_estadoRowDeleted(Me, New cambio_estadoRowChangeEvent(CType(e.Row,cambio_estadoRow), e.Action))
                End If
            End Sub
            
            Protected Overrides Sub OnRowDeleting(ByVal e As DataRowChangeEventArgs)
                MyBase.OnRowDeleting(e)
                If (Not (Me.cambio_estadoRowDeletingEvent) Is Nothing) Then
                    RaiseEvent cambio_estadoRowDeleting(Me, New cambio_estadoRowChangeEvent(CType(e.Row,cambio_estadoRow), e.Action))
                End If
            End Sub
            
            Public Sub Removecambio_estadoRow(ByVal row As cambio_estadoRow)
                Me.Rows.Remove(row)
            End Sub
        End Class
        
        <System.Diagnostics.DebuggerStepThrough()>  _
        Public Class cambio_estadoRow
            Inherits DataRow
            ...
            Friend Sub New(ByVal rb As DataRowBuilder)
                MyBase.New(rb)
                Me.tablecambio_estado = CType(Me.Table,cambio_estadoDataTable)
            End Sub
            
            Public Property epis_key_cima As Integer
                Get
                    Try 
                        Return CType(Me(Me.tablecambio_estado.epis_key_cimaColumn),Integer)
                    Catch e As InvalidCastException
                        Throw New StrongTypingException("No se puede obtener el valor porque es DBNull.", e)
                    End Try
                End Get
                Set
                    Me(Me.tablecambio_estado.epis_key_cimaColumn) = value
                End Set
            End Property
            ...
            Public Property estado As String
                Get
                    Try 
                        Return CType(Me(Me.tablecambio_estado.estadoColumn),String)
                    Catch e As InvalidCastException
                        Throw New StrongTypingException("No se puede obtener el valor porque es DBNull.", e)
                    End Try
                End Get
                Set
                    Me(Me.tablecambio_estado.estadoColumn) = value
                End Set
            End Property
            
            Public Function Isepis_key_cimaNull() As Boolean
                Return Me.IsNull(Me.tablecambio_estado.epis_key_cimaColumn)
            End Function
            
            Public Sub Setepis_key_cimaNull()
                Me(Me.tablecambio_estado.epis_key_cimaColumn) = System.Convert.DBNull
            End Sub
            
            Public Function IsestadoNull() As Boolean
                Return Me.IsNull(Me.tablecambio_estado.estadoColumn)
            End Function
            
            Public Sub SetestadoNull()
                Me(Me.tablecambio_estado.estadoColumn) = System.Convert.DBNull
            End Sub
        End Class
        
        <System.Diagnostics.DebuggerStepThrough()>  _
        Public Class cambio_estadoRowChangeEvent
            Inherits EventArgs
            
            Private eventRow As cambio_estadoRow
            
            Private eventAction As DataRowAction
            
            Public Sub New(ByVal row As cambio_estadoRow, ByVal action As DataRowAction)
                MyBase.New
                Me.eventRow = row
                Me.eventAction = action
            End Sub
            
            Public ReadOnly Property Row As cambio_estadoRow
                Get
                    Return Me.eventRow
                End Get
            End Property
