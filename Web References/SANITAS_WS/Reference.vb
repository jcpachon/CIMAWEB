...
'
Namespace SANITAS_WS
    
    '<remarks/>
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Web.Services.WebServiceBindingAttribute(Name:="Service1Soap", [Namespace]:="http://tempuri.org/SANITAS_WS/Service1")>  _
    Public Class Service1
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://10.8.50.31/SANITAS_WS/Service1.asmx"
        End Sub
        
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/SANITAS_WS/Service1/ConsultaAgendaDia", RequestNamespace:="http://tempuri.org/SANITAS_WS/Service1", ResponseNamespace:="http://tempuri.org/SANITAS_WS/Service1", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function ConsultaAgendaDia(ByVal login As String, ByVal password As String, ByVal servicio As String, ByVal agenda As String, ByVal fecha As String) As ds_citas
            Dim results() As Object = Me.Invoke("ConsultaAgendaDia", New Object() {login, password, servicio, agenda, fecha})
            Return CType(results(0),ds_citas)
        End Function
        
        '<remarks/>
        Public Function BeginConsultaAgendaDia(ByVal login As String, ByVal password As String, ByVal servicio As String, ByVal agenda As String, ByVal fecha As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ConsultaAgendaDia", New Object() {login, password, servicio, agenda, fecha}, callback, asyncState)
        End Function
        
        '<remarks/>
        Public Function EndConsultaAgendaDia(ByVal asyncResult As System.IAsyncResult) As ds_citas
    ...
    Public Class ds_citas
        ...
        Public Class citasDataTable
            ...
            Public Overloads Function AddcitasRow(ByVal estadoCita As String, ByVal hora As String, ByVal nombre As String, ByVal prestacion As String, ByVal garante As String) As citasRow
                Dim rowcitasRow As citasRow = CType(Me.NewRow,citasRow)
                rowcitasRow.ItemArray = New Object() {estadoCita, hora, nombre, prestacion, garante}
