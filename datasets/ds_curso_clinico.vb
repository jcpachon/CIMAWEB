...
Public Class ds_curso_clinico
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As ds_curso_clinico = CType(MyBase.Clone,ds_curso_clinico)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "ds_curso_clinico"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/ds_curso_clinico.xsd"
    ...
    Public Class cima_informes_masterDataTable
        ...
        Public Overloads Function Addcima_informes_masterRow(ByVal cabecera As String, ByVal valor As String, ByVal id_usuario As String, ByVal fecha_creacion As String, ByVal padre As Integer, ByVal id_informe_master As Integer) As cima_informes_masterRow
            Dim rowcima_informes_masterRow As cima_informes_masterRow = CType(Me.NewRow,cima_informes_masterRow)
            rowcima_informes_masterRow.ItemArray = New Object() {cabecera, valor, id_usuario, fecha_creacion, padre, id_informe_master}
    ...
    Public Class cima_informes_masterRow
        ...
        Public Property valor As String
            Get
                Try 
                    Return CType(Me(Me.tablecima_informes_master.valorColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("No se puede obtener el valor porque es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecima_informes_master.valorColumn) = value
            End Set
        End Property
        ...
        Public Property fecha_creacion As String
            Get
                Try 
                    Return CType(Me(Me.tablecima_informes_master.fecha_creacionColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("No se puede obtener el valor porque es DBNull.", e)
                End Try
            End Get
        ...
        Public Property padre As Integer
            Get
                Try 
                    Return CType(Me(Me.tablecima_informes_master.padreColumn),Integer)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("No se puede obtener el valor porque es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecima_informes_master.padreColumn) = value
            End Set
        End Property
        ...
        Public Property id_informe_master As Integer
            Get
                Try 
                    Return CType(Me(Me.tablecima_informes_master.id_informe_masterColumn),Integer)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("No se puede obtener el valor porque es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecima_informes_master.id_informe_masterColumn) = value
            End Set
        End Property
        ...
        Public Function IsvalorNull() As Boolean
            Return Me.IsNull(Me.tablecima_informes_master.valorColumn)
        End Function
        
        Public Sub SetvalorNull()
            Me(Me.tablecima_informes_master.valorColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Function IspadreNull() As Boolean
            Return Me.IsNull(Me.tablecima_informes_master.padreColumn)
        End Function
        
        Public Sub SetpadreNull()
            Me(Me.tablecima_informes_master.padreColumn) = System.Convert.DBNull
        End Sub
        
        Public Function Isid_informe_masterNull() As Boolean
            Return Me.IsNull(Me.tablecima_informes_master.id_informe_masterColumn)
        End Function
        
        Public Sub Setid_informe_masterNull()
            Me(Me.tablecima_informes_master.id_informe_masterColumn) = System.Convert.DBNull
        End Sub
    End Class
