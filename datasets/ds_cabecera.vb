...
Public Class ds_cabecera
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As ds_cabecera = CType(MyBase.Clone,ds_cabecera)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "ds_cabecera"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/ds_cabecera.xsd"
    ...
    Public Class cima_informes_masterDataTable
        ...
        Public Overloads Function Addcima_informes_masterRow(ByVal cabecera As String) As cima_informes_masterRow
            Dim rowcima_informes_masterRow As cima_informes_masterRow = CType(Me.NewRow,cima_informes_masterRow)
            rowcima_informes_masterRow.ItemArray = New Object() {cabecera}
