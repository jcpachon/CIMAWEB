...
Public Class ds_informes_master
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As ds_informes_master = CType(MyBase.Clone,ds_informes_master)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "ds_informes_master"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/ds_informes_master.xsd"
    ...
    Public Class cima_informes_masterDataTable
        ...
        Public Overloads Function Addcima_informes_masterRow(ByVal cabecera As String, ByVal id_usuario As String, ByVal fecha_creacion As Date, ByVal episodio As String) As cima_informes_masterRow
            Dim rowcima_informes_masterRow As cima_informes_masterRow = CType(Me.NewRow,cima_informes_masterRow)
            rowcima_informes_masterRow.ItemArray = New Object() {cabecera, id_usuario, fecha_creacion, episodio}
