...
Public Class ds_agen_agenname
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As ds_agen_agenname = CType(MyBase.Clone,ds_agen_agenname)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "ds_agen_agenname"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/ds_agen_agenname.xsd"
    ...
    Public Class agenDataTable
        ...
        Public Overloads Function AddagenRow(ByVal agenname As String) As agenRow
            Dim rowagenRow As agenRow = CType(Me.NewRow,agenRow)
            rowagenRow.ItemArray = New Object() {agenname}
