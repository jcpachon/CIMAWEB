<%@ Page Language="vb" AutoEventWireup="false" Codebehind="form_busca_persona_multicitas.aspx.vb" Inherits="zeus.form_busca_persona_multicitas"%>
...
method=post>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
					<TD style="HEIGHT: 22px" width="150"><asp:label id="Label1" runat="server" Width="170px" CssClass="letra_pequena">Apellidos, Nombre (* de comodín):   </asp:label></TD>
				...
				<% if ispostback OR request("control") = "True" then 
