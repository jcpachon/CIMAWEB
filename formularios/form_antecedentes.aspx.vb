...
#Region " Código generado por el Diseñador de Web Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.Ds_antecedentes1 = New cimaweb.ds_antecedentes
    ...
    End Sub
    Protected WithEvents Ds_antecedentes1 As cimaweb.ds_antecedentes
...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        'JGM Modificació 02/12/2010
        ' Guardem indicador si hem de donar avís.
        Dim aviso1 As Char
        Dim aviso2 As Char
        Dim aviso3 As Char
        ...
        If IsNumeric(Session("pers_key")) = True Then
            ...
            str_sql = "dbo.SP_CIMACEX_ALTA_ALERTAS_PERS " & Session("pers_key") & ",'" & Trim(Request("TextBox1")) & "','" & Trim(Request("TextBox2")) & "','" & Trim(Request("TextBox3")) & "','" & Trim(Request("TextBox4")) & "','" & Trim(aviso1) & "','" & Trim(aviso2) & "','" & Trim(aviso3) & "'"
    ...
    Private Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
        'JGM Modificació per controlar quan actualitzar
