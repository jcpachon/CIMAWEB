<%@ Page Language="vb" AutoEventWireup="false" Codebehind="form_curso_clinico_lat_left.aspx.vb" Inherits="zeus.form_curso_clinico_lat_left"%>
...
<HTML>
	<HEAD>
		<title>form_curso_clinico_lat_left</title>
				...
				<TR>
					<TD vAlign="top">
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								<TD style="WIDTH: 610px" vAlign="top" width="610">
											...
											<TD vAlign="middle">
												<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
													<TR>
														...
														<TD class="letra_pequena_negrita" width="11"></TD>
														<TD class="cabecera_formulario">CURSO CLÍNICO</TD>
													</TR>
													<!--TR>
							...
							%>
							<!--TR>
								<TD class="menu_lateral_izquierdo" colSpan="3" height="11"></TD>
							</TR>
							<TR>
								<TD class="letra_pequena_negrita" colSpan="3" height="11"></TD>
							</TR-->
							<TR>
							...
							<TR>
								<TD class="letra_pequena_negrita" colSpan="3" height="11">Fecha de Creación:<% =" " & objRow2.Item(3) & "   " %>
									Autor:<% =" " & objRow2.Item(2) & "   " %></TD>
							</TR>
							<TR>
								<TD class="letra_pequena_negrita" colSpan="3" height="11"></TD>
							</TR>
