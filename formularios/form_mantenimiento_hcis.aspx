<%@ Page Language="vb" AutoEventWireup="false" Codebehind="form_mantenimiento_hcis.aspx.vb" Inherits="cimaweb.form_mantenimiento_hcis" %>
<%@ Register TagPrefix="uo_seguridad" TagName="uo_seguridad" Src="../user_objects/uo_seguridad.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>form_mantenimiento_hcis</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE style="Z-INDEX: 101; POSITION: absolute; WIDTH: 100%; HEIGHT: 100%; TOP: 11px; LEFT: 11px"
				...
				<asp:panel id="Panel2" runat="server">
					<TR>
						<TD height="250" colSpan="3">
							<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="0" width="100%" height="100%">
								...
								<TR>
									<TD class="menu_lateral_izquierdo" height="11" width="50%" colSpan="3" align="center">Par 
										CIMA - HCIS</TD>
								</TR>
								<TR>
									<TD height="11" colSpan="3"></TD>
								...
								<TR>
									<TD vAlign="top" width="50%" colSpan="3" align="center">
										<asp:datagrid id=DataGrid1 runat="server" Width="650px" DataSource="<%# Ds_par_SNT_CIMA1 %>" DataMember="ds_par_SNT_CIMA" DataKeyField="id" CellPadding="3" BorderWidth="1px" BorderColor="#999999" GridLines="Vertical" PageSize="15" AllowPaging="True" BackColor="White" ForeColor="Black" Font-Size="7pt" Font-Names="Verdana" AutoGenerateColumns="False">
					...
					<TR>
						<TD height="250" colSpan="3">
							<TABLE id="Table3" border="0" cellSpacing="0" cellPadding="0" width="100%" height="100%">
								<TR>
									<TD height="11" colSpan="3"></TD>
								</TR>
								<TR>
								...
								<TR>
									<TD vAlign="top" width="50%" colSpan="3" align="center">
										<asp:DataGrid id=DataGrid2 runat="server" Width="750px" DataSource="<%# Ds_par_SNT_CIMA_garante1 %>" DataMember="ds_par_SNT_CIMA_garante" DataKeyField="id" BorderWidth="1px" BorderColor="#999999" GridLines="Vertical" AllowPaging="True" ForeColor="Black" Font-Size="7pt" Font-Names="Verdana" AutoGenerateColumns="False">
											<FooterStyle BackColor="#CCCCCC"></FooterStyle>
											<SelectedItemStyle ForeColor="White" BackColor="#000099"></SelectedItemStyle>
											<AlternatingItemStyle Font-Size="XX-Small" BackColor="#CCCCCC"></AlternatingItemStyle>
											<ItemStyle Font-Size="XX-Small"></ItemStyle>
