...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="form_usuarios_agendas.aspx.vb" Inherits="zeus.form_usuarios_agendas"%>
	...
	<body MS_POSITIONING="GridLayout">
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 11px; WIDTH: 100%; POSITION: absolute; TOP: 11px; HEIGHT: 100%"
				...
				<TR>
					<TD class="cabecera_formulario" colSpan="3" height="22">Mantenimiento de Agendas 
						por Usuario</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD colSpan="3" height="30">
						<asp:label id="Label1" runat="server" CssClass="letra_pequena">Usuario: </asp:label>
						<asp:dropdownlist id=DropDownList1 runat="server" CssClass="letra_pequena" AutoPostBack="True" DataSource="<%# Ds_usuarios1 %>" DataMember="cima_usuarios" DataTextField="descripcion" DataValueField="id_usuario">
						</asp:dropdownlist></TD>
				</TR>
				<TR>
						...
						<TABLE id="Table2" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD align="center" vAlign="top" width="50%">
									<asp:DataGrid id=DataGrid1 runat="server" DataSource="<%# Ds_agen1 %>" DataMember="agen" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" BackColor="White" CellPadding="3" GridLines="Vertical" AllowPaging="True" Font-Size="7pt" PageSize="25" Width="325px" ForeColor="Black" Font-Names="Verdana">
								...
								<TD align="center" vAlign="top" width="50%">
									<asp:DataGrid id=DataGrid2 runat="server" DataSource="<%# Ds_usuarios_agendas1 %>" DataMember="cima_usuarios_agen" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" BackColor="White" CellPadding="3" GridLines="Vertical" AllowPaging="True" Font-Size="7pt" PageSize="25" Width="325px" ForeColor="Black" Font-Names="Verdana">
										<FooterStyle BackColor="#CCCCCC"></FooterStyle>
										<SelectedItemStyle ForeColor="White" BackColor="#000099"></SelectedItemStyle>
										<AlternatingItemStyle Font-Size="XX-Small" BackColor="#CCCCCC"></AlternatingItemStyle>
										<ItemStyle Font-Size="XX-Small"></ItemStyle>
