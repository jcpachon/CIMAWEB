...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="form_busca_persona_citas_rapidas.aspx.vb" Inherits="zeus.form_busca_persona_citas_rapidas"%>
...
<HTML>
	...
	<body onload="javascript:window.Form1.apnombre.focus();" MS_POSITIONING="GridLayout">
	...
	function enviar(pers_key,dni,persona){
        ...
        window.close();*/
        //alert(pers_key);
        opener.Form1.pers_key_paciente.value = pers_key;
        opener.Form1.nombre.value = persona;
        opener.Form1.submit();
        window.close();
    ...
    var valor = document.all.dni.value;
...
method=post>
		...
		<form id="Form1" method="post" runat="server">
			<input type="hidden" name="retorno_pers_key"> <input type="hidden" name="nombre">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
					<asp:Panel id="Panel1" runat="server" Visible="false">
						<TD style="HEIGHT: 22px" width="11">
							<asp:label id="Label1" runat="server" Width="170px" CssClass="letra_pequena">Apellidos, Nombre (* de comodín):   </asp:label></TD>
				...
				<TR>
					<TD colSpan="2" height="11"><asp:checkbox id="CheckBox1" tabIndex="3" runat="server" Width="144px" CssClass="letra_pequena_negrita"
							Text="Pacientes propios" Enabled="False" TextAlign="Left"></asp:checkbox></TD>
					<TD height="11"></TD>
					<TD height="11"></TD>
					<TD height="11"></TD>
					<TD width="11" height="11"></TD>
				...
				<% if (ispostback OR request("control") = "True") and (len(trim(Request("apnombre"))) > 0 or len(trim(Request("dni"))) > 0) then 
				...
				<TR>
					<TD colSpan="9" height="11">
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							If Trim(Me.apnombre.Text) = "" And Trim(Me.dni.Text) = "" Then

							%>
							<TR height="77" valign="middle">
								<TD colspan="7"></TD>
							</TR>
							<TR height="11" valign="middle">
								<TD colspan="7" class="letra_muy_pequena_verde_negrita">Debe cumplimentar alguno de 
									los campos de búsqueda.</TD>
							</TR>
							<%
