<%@ Page Language="vb" AutoEventWireup="false" Codebehind="form_seleccion_consentimientos.aspx.vb" Inherits="zeus.form_seleccion_consentimientos"%>
			...
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 11px; WIDTH: 100%; POSITION: absolute; TOP: 11px; HEIGHT: 100%"
				...
				<TR>
					<TD class="cabecera_formulario" style="HEIGHT: 22px" colSpan="3" height="22">Selección 
						de Consentimientos</TD>
				</TR>
				<TR>
					<TD colSpan="3" height="11"></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 640px" height="30"><asp:label id="Label1" runat="server" CssClass="letra_pequena">Consentimiento: </asp:label><asp:dropdownlist id=DropDownList1 runat="server" CssClass="letra_pequena" DataValueField="id_consentimiento" DataTextField="descripcion" DataMember="cima_consentimientos" DataSource="<%# Ds_consentimientos1 %>" AutoPostBack="True" Width="250px">
				...
				<TR>
					<TD vAlign="top" colSpan="3" height="120"><asp:datalist id=DataList1 runat="server" DataMember="cima_consentimientos" DataSource="<%# Ds_consentimientos1 %>" DESIGNTIMEDRAGDROP="463" DataKeyField="id_consentimiento" BorderColor="Black" BorderStyle="None" BackColor="White" CellPadding="3" GridLines="Horizontal" BorderWidth="1px" Height="120px" Width="100%" Font-Size="7pt" Font-Names="Verdana" ForeColor="Black">
							...
							<ItemTemplate>
								<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
									...
									<TR>
										<TD class="letra_pequena" width="120">ID Consentimiento:&nbsp; &nbsp;
										</TD>
										<TD>
											<P>
												<asp:TextBox id=id_consentimiento runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.id_consentimiento") %>' Enabled="False">
												</asp:TextBox></P>
										</TD>
										<TD width="11"></TD>
										<TD></TD>
