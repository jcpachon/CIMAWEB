...
#End Region
    ...
    Private Sub ImageButton2_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton2.Click
        ...
        objExport = objCR_rpt_prestaciones.ExportOptions
    ...
    Private Sub cargar()
        ...
        Me.OdbcDataAdapter1.SelectCommand.CommandText = "SELECT agenproc.agenprocdesc as 'prestacion', COUNT(*) as 'numero'" & _
        ...
        "GROUP BY agenproc.agenprocdesc"

        Me.OdbcDataAdapter1.Fill(Me.Ds_cr_prestaciones1.cr_prestaciones)

        objCR_rpt_prestaciones.SetParameterValue("arg_fecha_ini", objCIMA.f_formato_fecha(Me.TextBox1.Text))
        objCR_rpt_prestaciones.SetParameterValue("arg_fecha_fin", objCIMA.f_formato_fecha(Me.TextBox2.Text))
        objCR_rpt_prestaciones.SetParameterValue("arg_agenda_desc", Session("agencode")) ' El código de la agenda.

        objCR_rpt_prestaciones.SetDataSource(Me.Ds_cr_prestaciones1)

        Me.CrystalReportViewer1.ReportSource = objCR_rpt_prestaciones
