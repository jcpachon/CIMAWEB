...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="informe_curso_clinico.aspx.vb" Inherits="cimaweb.informe_curso_clinico"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Curso Clínico</title>
				...
				<TR>
					<TD vAlign="top">
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							...
							if objRow2.Item(0)<>str_memorion then
							
							str_memorion=objRow2.Item(0)
							
							%>
							<TR>
								<TD class="cabecera_titulo_informe" colSpan="3" height="11">Título Informe:<% =" " & str_memorion & "   " %></TD>
							</TR>
							<TR>
							...
							if objRow2.Item(4) = 1 then
							
							%>
							<TR>
								<TD class="fondo_formulario_2" colSpan="3" height="11">MOTIVO</TD>
							</TR>
							<TR>
							...
							%>
							<TR>
								<TD class="fondo_formulario_2" colSpan="3" height="11">DESCRIPCIÓN</TD>
							</TR>
							<TR>
								<TD class="letra" colSpan="3" height="11">
									<script type="text/javascript">
