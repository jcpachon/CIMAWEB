...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Label1.Text = Request("episodio")
        ...
        If IsPostBack = False Then
            ...
            str_menu = "dbo.SP_CIMACEX_RECUPERA_INFORME_RESTO '" & Session("episodio") & "'"

            objDS = objCIMA.f_consulta(str_menu, Session("cadena_conexion"))

            Me.Label6.Text = objDS.Tables(0).Rows(0).Item(0)
            Me.Label8.Text = objDS.Tables(0).Rows(0).Item(1)
            Me.Label11.Text = objDS.Tables(0).Rows(0).Item(2)
            Me.Label10.Text = objDS.Tables(0).Rows(0).Item(3)
    ...
    Private Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
        ...
        If Request("ok") = "S" Then
            ...
            If Request("tipo") = "N" Then
                ...
                str_menu = "dbo.SP_CIMACEX_ALTA_INFORMES '" & Request("cabecera") & "', '" & Session("usuario") & "', '" & Session("episodio") & "', '" & Request("motivo") & "', '" & Request("diagnostico") & "', " & Session("id_plantilla")
