Public Class informe_curso_clinico_grupo
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        " INNER JOIN hpro ON bookproc.hpro_key=hpro.hpro_key WHERE (pers.pers_key = " & Request("pers_key") & " AND (appostatcode <> 'A')) UNION " & _
        ...
        " INNER JOIN tact on tact.tactcode=epis.tactcode WHERE pers.pers_key = " & Request("pers_key") & " AND (tact.tactcode = 'UR') " & _
        ...
        If IsPostBack = False Then
            ...
            Me.OdbcConnection1.Open()
            Me.OdbcDataAdapter2.SelectCommand.Parameters(0).Value = Request("pers_key")
